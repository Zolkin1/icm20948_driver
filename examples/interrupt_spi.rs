...
mod app {
    ...
    fn init(cx: init::Context) -> (Shared, Local, init::Monotonics) {
        ...
        // Setup heartbeat LED & interrupt pin
        ...
        unwrap!(imu.config_gyro_rate(5));              // While gyro is enabled this determines the ODR (output data rate). See data sheet.
        unwrap!(imu.config_acc_rate(5));
